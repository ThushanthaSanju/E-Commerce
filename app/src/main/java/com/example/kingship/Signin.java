...
public class Signin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        username = findViewById(R.id.editTextEmailSignin); //retrieve data from db
        ...
        login.setOnClickListener(new View.OnClickListener() { //signin
            @Override
            public void onClick(View view) {
        ...
        adsign.setOnClickListener(new View.OnClickListener() { //admin sign
            @Override
            public void onClick(View view) {
    ...
    public void buttonLogin_onClick(View view) {
        ...
        if (account == null){ //check invalid account
