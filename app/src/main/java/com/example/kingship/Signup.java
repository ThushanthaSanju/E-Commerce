...
public class Signup extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        username = findViewById(R.id.editTextPersonName); //value assigning from ui to variables
        ...
        signin.setOnClickListener(new View.OnClickListener() { //redirect to signin
            @Override
            public void onClick(View view) {
    ...
    public void buttonSave_onClick(View view) { //checkbox seller,customer
